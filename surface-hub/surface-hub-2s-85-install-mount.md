...
> [!WARNING]
> **Control y preparación del sitio**<br>
>- El dispositivo es muy intenso. Para reducir el riesgo de daños personales, daños o daños en el dispositivo debido a su tamaño y peso, es importante mantener el dispositivo en posición vertical.
>- Antes de mover el dispositivo al lugar donde se instalará, realiza una encuesta en el sitio para determinar cómo moverlo de forma segura a la ubicación donde se desempaquetará y montará.
>- Use siempre al menos dos personas para desempaquetar e instalar.
>- Una vez que se desempaquete el dispositivo, debe montarse inmediatamente, por lo que el sistema de montaje debe estar en su lugar antes de desempaquetar. Si vas a montar en un soporte de rodadura, bloquea o bloquea los volantes del soporte antes de desempaquetar.
>- Para evitar que se desvíe el tiempo de peligro, mantenga el área de ensamblado libre de materiales de empaquetado.

> [!IMPORTANT]
>Antes de continuar, revise la información de seguridad adicional que se muestra en el [Apéndice](#appendix) siguiente.
...
## 2. Quitar empaquetado externo negro

1. Quite las piezas de esquina negra (4).
2. Quita la compatibilidad con las almohadillas del centro negro.

 ![Quitar empaquetado externo negro](images/hub85mount2a.png) <br>
...
1. Mover el ensamblado de paletas a la ubicación del almacén.
2. Frenos de rueda de bloqueo (4).
3. Empaquetado interno de la diapositiva fuera de la paleta.

 ![Quitar el marco de empaquetado interno de la paleta](images/hub85mount3b.png) <br>

## 4. Girar el marco de empaquetado para ajustarse al proceso
...
1. Con el extremo biselado, gira hacia atrás en la paleta.
2. Desbloquea los frenos de rueda (x4).
3. Mover el producto a la ubicación del montaje de la pared o del carro.

 ![Colocar Surface Hub 85" de nuevo en la paleta](images/hub85mount6a.png) <br>

## 7. Colocar Surface Hub 85" en montaje de pared o carro

1. Coloca Hub 2S delante del montaje en la pared o del carro.
2. Frenos de rueda de bloqueo (x4).
3. Empaquetado interno de la diapositiva fuera de la paleta.
4. Corte las 3 tirantes de fibra.
5. Quite la tapa.
...
9. Quite las piezas finales de la madero mediante las cuatro palancas de mandos en la base de la madería.
   ...
   > [!CAUTION]
   >  No deje hub 2S 85" desatendido. Se necesita una persona adicional para mantener el dispositivo vertical. Una vez que se quitan las piezas finales, un mínimo de una persona debe mantener el contacto con el Hub 2S hasta que se complete la colocación en el montaje en la pared o en el carro.

10. Levanta el plywood de un extremo hacia arriba y hacia atrás.
11. Quita la etiqueta de los remates de atrás.
12. Levanta el Hub 2S de la bandeja inferior y colócarlo en el carro o en la pared.
...
18. Presione el botón de encendido en la parte inferior derecha. La instalación ya está completa.
...
Surface Hub 2S 85" usa un patrón de montaje VESA de 600 x 600. Como se muestra en la siguiente imagen, Microsoft se ha asociado con [Steelcase](https://www.steelcase.com/products/collaboration/steelcase-roam/) para crear opciones de montaje compatibles con el diseño único de Surface Hub 2S 85". 

![Montaje de pared en mal estado](images/sh2-steelcasemount.png) <br>

### Dimensiones de montaje

Si usas otras opciones de montaje (que no son en mal estado), necesitarás espaciadores para tener en cuenta la caja de cálculo en la parte posterior del dispositivo. Los espaciadores y otros accesorios certificados están disponibles en [Salamander Designs.](http://www.salamandercommercial.com/surface-hub-2)


![Detalle de las dimensiones de Surface Hub 85" para el montaje](images/sh2-85-measure2.png) <br>

![Dimensiones de Surface Hub 85" para montaje](images/sh2-85-measure1.png) <br>


## Kit de apareado complementario

Se puede encontrar un conjunto adicional de materiales de cierre de empaquetado interno en el kit adjunto en la parte posterior, inferior derecha.
...
> [!WARNING]
>  **Montaje adecuado**<br> El dispositivo es pesado y se une a un carro o montaje en la pared. Para reducir el riesgo de daños, daños o daños en el dispositivo: 
...
> Para evitar el riesgo de daños personales, daños o daños en un carro o dispositivo montado de pie cuando se mueve:
> - Usa solo un carro o soporte que sea compatible con este dispositivo.
...
La pantalla táctil del dispositivo, como la mayoría de las pantallas táctiles, está hecha de cristal. El cristal puede romperse si el dispositivo se cae o recibe un impacto significativo. Para reducir el riesgo de daños personales, evite tocar la pantalla si el cristal está roto, recortado o roto, y organice para reemplazar la pantalla.
Una pantalla táctil descomprimida o recortada causada por un uso incorrecto o abuso del dispositivo no está cubierta por la garantía limitada del producto.

> [!WARNING]
>  **Instalación adecuada**<br>
Para evitar riesgos relacionados con la instalación incorrecta del dispositivo, las personas que han leído y leído la instrucción de instalación deben realizar la instalación antes de comenzar el trabajo. Si no tienes el equipo o la experiencia necesarios, o si no estás seguro de que la superficie de montaje puede admitir correctamente consultar a un instalador profesional.


## Más información

- [Steelcase Roam (colección)](https://www.steelcase.com/products/collaboration/steelcase-roam/)
- [Diseños salamandra](http://www.salamandercommercial.com/surface-hub-2)