...
##  <a name="updating-surface-device-drivers-and-firmware"></a>Actualización de los drivers y el firmware de los dispositivos de superficie
...
##  <a name="surface-ethernet-adapters-and-configuration-manager-deployment"></a>Adaptadores Ethernet de Surface y implementación de Configuration Manager
...
##  <a name="use-prestaged-media-with-surface-clients"></a>Usar medios preconfigurados con clientes Surface
...
##  <a name="licensing-conflicts-with-oem-activation-3.0"></a>Conflictos de licencias con activación de OEM 3,0
...
##  <a name="configure-push-button-reset"></a>Configurar restablecimiento del botón
