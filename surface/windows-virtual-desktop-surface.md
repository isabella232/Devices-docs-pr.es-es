...
- Factores de forma **flexibles,** como dispositivos 2 en 1, como Surface Pro 7+, Surface Go 2, Surface Pro 7 y Surface Pro X con lápiz, teclado táctil y deseste. Incluso puedes usar el nuevo Surface Duo para conectarte a WVD.
...
Los dispositivos Surface 2 en 1, [incluidos Surface Go 2](https://www.microsoft.com/p/surface-go-2) (10.5"), [Surface Pro 7+](https://www.microsoft.com/surface/business/surface-pro-7-plus) (12") y [Surface Pro X](https://www.microsoft.com/p/surface-pro-x/) (13"), proporcionan a los usuarios el punto de conexión de escritorio en la nube ideal para reunir el equilibrio óptimo de portabilidad, versatilidad, energía y batería de todo el día. Desde ingenieros de sitio que dependen de Surface Go 2 en modo tableta hasta asesores financieros que adjuntan Surface Pro 7 a una base dock y varios monitores, los dispositivos 2 en 1 proporcionan la versatilidad que ha llegado a definir el lugar de trabajo moderno.
 ...
 A diferencia de los "terminales" de VDI fijos tradicionales, los dispositivos Surface permiten a los usuarios trabajar desde cualquier lugar y permiten que las empresas permanezcan viables y operativas durante eventos imprevistos, desde condiciones meteorológicas extremas hasta emergencias de salud pública. Con soporte para escenarios persistentes, a petición y just-in-time, los dispositivos Surface ayudan de forma eficaz a las empresas a mantener operaciones en curso y mitigar el riesgo de eventos perjudiciales. Las características diseñadas para mejorar la productividad en dispositivos Surface 2 en 1 incluyen:

- Pantallas dinámicas de alta resolución con relación de aspecto de 3:2 para realizar el trabajo.
- Entrada de entrada de teclado natural y multi táctil para experiencias más envolventes.
...
- Micrófonos de alto nivel y altavoces de alto rendimiento para reuniones virtuales mejoradas.
- Seguridad biométrica, incluida la cámara integrada de Windows Hello que viene de serie en todos los dispositivos Surface.
- Duración larga de <a href="#2"><sup> la batería 2 </sup></a> y carga rápida.
- Opciones LTE 3 en dispositivos modernos como Surface Pro X y Surface Go 2 para una conectividad segura <a href="#3"><sup> </sup></a> y sin complicaciones.
...
- Seguridad de varios niveles de acceso a datos y recursos de la organización.
- Cumplimiento de las normativas del sector.
- Soporte para un personal cada vez más flexible.
...
Para mantener la continuidad empresarial y mantener la productividad de los empleados, los dispositivos Surface pueden aumentar fácilmente la experiencia de escritorio virtual con acceso sin conexión a archivos, Aplicaciones de Microsoft 365 y de terceros. Las aplicaciones tradicionales como Microsoft Office, disponibles en .x86, x64, Plataforma universal de Windows, plataformas ARM, permiten a los usuarios mantener la productividad en "modo sin conexión". Los archivos del entorno de nube de escritorio virtual también se pueden sincronizar localmente en Surface con OneDrive para la Empresa para el acceso sin conexión. Puede tener la confianza de que toda la información "almacenada en caché" local está actualizada y segura.

Además de agregar compatibilidad para el acceso sin conexión a aplicaciones y archivos, los dispositivos Surface están diseñados para optimizar experiencias de colaboración como Microsoft Teams "En el dispositivo". Aunque algunas soluciones de VDI admiten el uso de Teams a través de una sesión virtual, los usuarios pueden beneficiarse de la experiencia más optimizada que proporciona una instancia de Teams instalada localmente. La localización de aplicaciones de colaboración y comunicaciones para canales multimedia como voz, vídeo y subtítulos en directo permite a las organizaciones aprovechar al máximo la capacidad de los dispositivos Surface para proporcionar experiencias optimizadas de Microsoft 365. La aparición de inteligencia artificial de Surface (IA) o "IA en el dispositivo" da vida a nuevas funcionalidades, como la tecnología de mirada ocular que ajusta la apariencia de los ojos para que el público te vea mirando directamente a la cámara al comunicarse a través de vídeo.
...
Para solucionar este problema, Azure ofrece la familia de máquinas virtuales de la serie N con capacidades de GPU DE NVIDIA (vGPU). Con vGPUs, TI puede compartir el rendimiento de la GPU en varias máquinas virtuales o cargas de trabajo que demandan energía asignando varias GPU a una sola máquina virtual. Para Surface esto significa que, independientemente del dispositivo que estés usando, desde el Surface Go 2 altamente portátil al portátil Surface Laptop 3, tu dispositivo tiene acceso al eficaz rendimiento de gráficos de clase de servidor.  Surface y vGPUs te permiten combinar todo lo que te gusta de Surface, para incluir lápiz, función táctil, teclado, panel táctil y pantallas PixelSense, con la funcionalidad de gráficos solo disponible en entornos informáticos de alto rendimiento. 
...
- Los dispositivos Surface con tecnología Microsoft 365 ofrecen a los usuarios hasta 5 horas en ganancias de productividad semanales con hasta 9 horas guardadas por semana para trabajadores altamente móviles, lo que proporciona a las organizaciones un 112 % de ROI en Microsoft 365 con Surface.
...
Al maximizar las eficiencias de la informática en la nube, la administración moderna permite a TI satisfacer mejor las necesidades de los usuarios, las partes interesadas y los clientes en un entorno empresarial cada vez más competitiva. Por ejemplo, puedes hacer que los dispositivos Surface se ejecuten con una interacción mínima del equipo. El programa de instalación es automático y autoservicio. Las actualizaciones son rápidas y fáciles para el equipo y los usuarios. Puedes administrar dispositivos independientemente de su ubicación física.
 
Las características de seguridad y administración que se entregan con Windows Virtual Desktop en Surface incluyen:

- **Windows Update.** Mantener Windows actualizado le ayuda a mantenerse al día de las nuevas amenazas de seguridad. Windows 10 se ha diseñado desde cero para ser más seguro y usar las últimas funcionalidades de hardware para mejorar la seguridad. Con una UEFI 5 y Windows Update para empresas diseñadas para propósitos que responde a amenazas en evolución, la protección de un extremo a otro es <a href="#5"><sup> </sup></a> segura y simplificada.

- **Cifrado de hardware.** El cifrado de dispositivos te permite proteger los datos de Surface para que solo puedan acceder a él las personas autorizadas. Todos los dispositivos Surface para empresas cuentan con un módulo de plataforma segura discreto (dTPM) que está protegido contra intrusiones, mientras que el software usa claves y medidas protegidas para comprobar la validez del software.
- **Windows Defender.** Windows Defender Antivirus reúne el aprendizaje automático, el análisis de big-data, la investigación detallada de la resistencia a amenazas y la infraestructura en la nube de Microsoft para proteger los dispositivos.  La herramienta está integrada y no necesita ningún agente adicional para implementarse en dispositivos o en el entorno de VDI, lo que simplifica la administración y optimiza el inicio del dispositivo. Windows Defender está integrado y no necesita que se implementen agentes adicionales en el dispositivo o en el entorno de VDI, lo que simplifica la administración y optimiza el inicio del dispositivo. La verdadera experiencia lista para su uso.
- **Unidades extraíbles:** un subconjunto de dispositivos Surface más recientes incluyen unidades SSD extraíbles 6 que proporcionan <a href="#6"><sup> un mayor control sobre la retención de </sup></a> datos.
- **Autenticación moderna:** Microsoft 365 y Surface es una plataforma unificada que ofrece todas las características de seguridad de Windows (sujetas a licencias y habilitación). Todos los dispositivos de cartera de Surface se proporcionan con una cámara personalizada, diseñada para Windows Hello para empresas que proporciona seguridad biométrica que persiste perfectamente desde el dispositivo hasta las experiencias basadas en VDI.
- Administración de **firmware** moderna: con la interfaz de configuración de firmware de dispositivo (DFCI), 7 administradores de TI pueden deshabilitar de forma remota los elementos de hardware en un nivel de firmware, como <a href="#7"><sup> micrófonos, puertos USB, ranuras de tarjeta SD, cámaras y Bluetooth que quita la energía del </sup></a> periférico. Windows Defender Credential Guard usa seguridad basada en virtualización para que solo el software del sistema con privilegios pueda acceder a ellos.
- **Compatibilidad con versiones anteriores y adelantadas:** los dispositivos con Windows 10 proporcionan compatibilidad con versiones anteriores y adelantadas en hardware, software y servicios. Microsoft cuenta con una sólida historia de mantenimiento de la compatibilidad heredada de hardware, periféricos, software y servicios a la vez que incorpora las tecnologías más recientes. Las empresas pueden planear inversiones de TI para que tengan una larga vida útil.
...
- [Modernizar los empleados con Microsoft Surface](https://boards.microsoft.com/public/prism/103849?token=754435c36d)
- [Guía de soluciones y contenido técnico de Surface](https://boards.microsoft.com/public/prism/104362/category/90968?token=09e688ec4a)
- [Seguridad de confianza cero de Microsoft](https://www.microsoft.com/security/business/zero-trust)


----------

<a id="1">1. Windows Virtual Desktop en Surface hace referencia a la ejecución de la infraestructura de Azure Virtual Desktop en un dispositivo Surface y se describe aquí como una solución de arquitectura, no como un producto </a> disponible por separado.<br>
<a id="2">2. </a> La duración de la batería varía considerablemente según la configuración, el uso y otros factores.<br>
<a id="3">3. </a> La disponibilidad y el rendimiento del servicio están sujetos a la red del proveedor de servicios. Póngase en contacto con su proveedor de servicios para obtener información detallada, compatibilidad, precios, tarjeta SIM y activación. Consulta todas las especificaciones y frecuencias en surface.com.<br>
...
<a id="5">5. Surface Go y Surface Go 2 usan una UEFI de terceros y no </a> admiten DFCI. DFCI está disponible actualmente para Surface Pro 7+, Surface Laptop Go, Surface Book 3, Surface Laptop 3, Surface Pro 7 y Surface Pro X.<br>
<a id="6">6. Ssd extraíble está disponible en Surface Laptop 3 y Surface Pro X. Ten en cuenta que la unidad de disco duro </a> no es extraíble para el usuario. La unidad de disco duro solo es extraíble por un técnico cualificado siguiendo las instrucciones de Microsoft.<br>
<a id="7">7. DFCI está disponible actualmente para </a> Surface Pro 7+, Surface Laptop Go, Surface Book 3, [](surface-manage-dfci-guide.md) Surface Laptop 3, Surface Pro 7 y Surface Pro X. Más información sobre cómo administrar la configuración de la UEFI de Surface.
