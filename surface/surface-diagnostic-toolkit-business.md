...
2. Descarga SDT Windows Installer Package (.msi) desde la página de descarga de [Surface Tools para](https://www.microsoft.com/download/details.aspx?id=46703) TI y cópielo en una ubicación preferida del dispositivo Surface, como Escritorio.
3. Aparece el asistente de configuración de SDT, como se muestra en la figura 1. Haz clic en **Siguiente**.
