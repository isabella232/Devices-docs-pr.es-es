...
##  <a name="central-update-management-in-commercial-environments"></a>Administración de actualizaciones centralizada en entornos comerciales
...
###  <a name="manage-updates-with-configuration-manager-and-intune"></a>Administrar las actualizaciones con Configuration Manager e Intune
...
###  <a name="manage-updates-with-microsoft-deployment-toolkit"></a>Administrar las actualizaciones con Microsoft Deployment Toolkit
...
##  <a name="managing-firmware-with-dfci"></a>Administración del firmware con DFCI
...
##  <a name="best-practices-for-update-deployment-processes"></a>Procedimientos recomendados para los procesos de implementación de actualizaciones
...
##  <a name="downloadable-surface-update-packages"></a>Paquetes de actualización superficial descargables
...
###  <a name="downloading-.msi-files"></a>Descargar archivos. msi
...
###  <a name="surface-.msi-naming-convention"></a>Convención de nomenclatura de Surface. msi
...
###  <a name="legacy-surface-.msi-naming-convention"></a>Convención de nomenclatura de la superficie heredada. msi
