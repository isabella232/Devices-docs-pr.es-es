...
4. Compruebe que ha configurado los controladores de Surface Laptop utilizando un perfil de selección o una variable **DriverGroup001**.
    ...
    - Para Surface Laptop 2, el modelo **es Surface Laptop 2**. El resto Surface Laptop controladores deben residir en la carpeta \MDT Deployment Share\Out-of-Box Drivers\Windows10\X64\Surface Laptop 2.
